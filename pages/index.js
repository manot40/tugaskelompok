    ...
    <div className="mx-auto h-screen flex justify-center items-center -m-0">
      <div className="container">
        <div className="flex flex-col w-full justify-center">
          <h1 className="text-4xl text-center font-bold mb-8 font-display">Halo 👋</h1>
          <h2 className="text-xl text-center mb-8">WebApp ReactJs untuk tugas kelompok Team 1 kelas MCCA</h2>
        </div>
        ...
        <div className="flex justify-center w-full font-display">
          <div className="w-2/3 2xl:w-1/4 xl:w-1/4">
            <div className="flex flex-col items-center">
              ...
              <select className="select select-bordered select-sm w-48 mb-8" data-choose-theme>
            ...
            <Link href="/tk1">
              <button className="w-full block btn btn-primary mb-4">Project Form TK1</button>
            </Link>
